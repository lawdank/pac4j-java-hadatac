...
//import controllers.annotator.routes;
//import http.ResumableUpload;
//import model.AssignOptionForm;
...
//        AssignOptionForm org.hadatac.data = form.get();
//
//        if (form.hasErrors()) {
...
//            }
//            file.setOwnerEmail(org.hadatac.data.getOption());
//            file.save();
...
//                file.setSubmissionTime(new SimpleDateFormat("yyyy/MM/dd HH:mm:ss").format(new Date()));
//            }
//            file.setDataAcquisitionUri(URIUtils.replacePrefixEx(org.hadatac.data.getOption()));
//            file.save();
//            return redirect(routes.AutoAnnotator.index(dir, "."));
//        }
//    }
...
//        try {
//            String org.hadatac.metadata = URLDecoder.decode(uploadedfile.getFilename(), "utf-8");
//            params = (JSONObject)parser.parse(org.hadatac.metadata);
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//
