...
//        Map<String, String> org.hadatac.data = form.rawData();
//
//        NameSpace.deleteAll();
//        for (int i = 0; i < Math.max(original_size, org.hadatac.data.size() / 3); ++i) {
//            if (!org.hadatac.data.containsKey("nsAbbrev" + String.valueOf(i + 1))) {
//                continue;
//            }
//
//            NameSpace ns = new NameSpace();
//            ns.setAbbreviation(org.hadatac.data.get("nsAbbrev" + String.valueOf(i + 1)));
//            ns.setName(org.hadatac.data.get("nsName" + String.valueOf(i + 1)));
//            ns.setType(org.hadatac.data.get("nsType" + String.valueOf(i + 1)));
//            ns.setURL(org.hadatac.data.get("nsURL" + String.valueOf(i + 1)));
//            ns.save();
//        }
