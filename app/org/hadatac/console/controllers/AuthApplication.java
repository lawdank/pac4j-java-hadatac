...
//    public Result restricted(Http.Request request) {
//        final SysUser localUser = this.userProvider.getUser(request.session());
//        return ok(restricted.render(localUser));
//    }
//
//    @Restrict(@Group(AuthApplication.DATA_OWNER_ROLE))
//    public Result profile(Http.Request request) {
//        final SysUser localUser = userProvider.getUser(request.session());
